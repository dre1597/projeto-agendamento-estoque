...
Permitir que o administrador controle se um usuário está ativo (pode acessar o sistema) ou inativo (sem acesso), sem excluí-lo.
...
- A listagem exibe todos os usuários, ativos, inativos e bloqueados.
